...
public:
    ...
    void increment_seen_count(MonraceId monrace_id) const;
    void reset_seen_count(MonraceId monrace_id) const;
    short get_seen_count(MonraceId monrace_id) const;
    void set_seen_count(MonraceId monrace_id, short count) const;
